...
Copy-Item 'docs/release-0.4.9.zh-CN.md' (Join-Path $package 'README-0.4.9.zh-CN.md')
Copy-Item 'docs/phone-cursor-performance.zh-CN.md' (Join-Path $package 'README-Cursor-Performance.zh-CN.md')
