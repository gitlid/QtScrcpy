...
if '#include "inputbindingfield.h"' in (root / 'QtScrcpy/ui/keymapeditor.cpp').read_text(encoding='utf-8'):
...
s = p.read_text(encoding='utf-8').replace('#include <cmath>', '#include <cmath>\n#include "inputbinding.h"')
...
s = p.read_text(encoding='utf-8').replace('#include "videoform.h"', '#include "videoform.h"\n#include "inputbinding.h"')
