...
[assembly: AssemblyDescription("Offline 0.4.5-rc.1 update with verified backups and script-preserving rollback")]
...
internal sealed class UpdateWindow : Form {
    ...
    public UpdateWindow() {
        Text="QtScrcpy 0.4.5-rc.1 · 保留脚本覆盖更新"; ClientSize=new Size(780,585);
