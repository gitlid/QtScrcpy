...
class UpdaterUpgradeTest {
    ...
    static void Main(string[] args) {
        ...
        try {
            Check(args.Length==2,"supply new payload and old 0.4.3 payload");
            Check(Updater.HashFile(args[0])==Updater.PayloadHash,"new payload SHA-256 mismatch");
            Check(Updater.HashFile(args[1])=="ed4a5b091485b9d3a8f7871e983e1d0a2dfdb44141866fd46edea82230278d04","old payload SHA-256 mismatch");
            ...
            Check(FileVersionInfo.GetVersionInfo(Path.Combine(target,"QtScrcpy.exe")).FileBuildPart==3,"wrong baseline app");
            ...
            Check(FileVersionInfo.GetVersionInfo(Path.Combine(target,"QtScrcpy.exe")).FileBuildPart==4,"app not upgraded to 0.4.4");
            ...
            Console.WriteLine("PASS real-0.4.3-to-0.4.4-and-rollback-preserves-later-scripts");
